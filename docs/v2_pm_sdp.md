...
│
├── shared_data/                      # ★ 전민재 PM/컨설턴트 담당이 채우는 데이터 자산
│   │                                 #   기본 챗봇 담당자는 읽기만
...
│   │                                 #   (기준=전민재 PM, 문항=팀 분담)
│   │                                 #   ※ 컨설팅 문항은 컨설턴트 챗봇 담당이 작성
│   └── benchmark_kb.json             # 업종 벤치마크 KB 데이터
│                                     #   (전민재 PM 또는 컨설턴트 챗봇 담당이 작성)
│
...
│   │
│   ├── pipeline_pm_sdp.png           # [PM] 파이프라인 다이어그램
...
③ 루트 tests/ 에 파일 추가 시, 파일명으로 담당이 구분되게 짓는다.
