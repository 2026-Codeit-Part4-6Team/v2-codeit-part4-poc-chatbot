...
### 소상공인시장진흥공단
- OpenAPI 반경내 상가업소 조회 명세서 — <a href="https://2026-codeit-part4-6team.github.io/codeit-part4-poc-chatbot/소상공인시장진흥공단_상가(상권)정보_storeListInRadius_OpenApi.pdf">바로가기</a>
...
## 시연 시나리오
1. `admin/demo/demo123` 계정 로그인 → 사이드바에서 컨텍스트 소스 체크박스, 플랜/채널 선택
